...
double u_k, u_k_1 = 0.0;      // Sinal de controlo aplicado no instante k
double e_k, e_k_1, e_k_2 = 0.0;      // Sinal de erro calculado no instante k


//constantes utilizadas na f.t. do controlador
double K = 0.167598529831592;
double Ti = 0.072333574832971;
double Td = 0.012110708117485;
double Kp = K;
double Ki = 1 / Ti;
double Kd = Td;
double Ts=0.1;
double a = K + (Ki*Ts / 2) + Kd / Ts;
...
void loop() {
  ...
  if (sample)
  {
    ...
    *************************************************************/
    ...
    u_k = u_k_1 + a * e_k + b * e_k_1 + c * e_k_2;
    if (u_k < 0) u_k = 0;
