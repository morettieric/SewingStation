...
double K=0.168944378473349; //Ganho do controlador
double Ti=0.097878329673360; //Constante de ganho Integral
double Td=0.680870631559591; //Constante de ganho Diferencial
double Ts=0.1; //Tempo de amostragem;
double N=5;
double a_i = K * Ts / Ti;
double b = Td / (Td + N);
double b_1 = (K * Td * (1 - b))/Ts;

double u_p_k, u_i_k, u_i_k_1,a_1 =0;
double u_d_k, u_d_k_1, y_k, y_k_1, e_k_11 =0;
