...
double u_k, u_k_1, u_k_2 = 0.0;      // Sinal de controlo aplicado no instante k
double e_k, e_k_1, e_k_2 = 0.0;      // Sinal de erro calculado no instante k
...
double a = 0.512394440010744;
double b = -0.371146500866463 / a;
double c = 0.202087509504686 / a;
double d = 1.000000000000000 / a;
double e = -0.535247922522263 / a;
double f = -0.464752077477737 / a;
...
void loop() {
  ...
  if (sample)
  {
    ...
    *************************************************************/
    ...
    e_k    = Setpoint - Vcarro;  // expressa em (m/h)
    //.................................................... Controlador PI
    //u_k = 0.3255 * e_k - 0.1724 * e_k_1 + u_k_1;
    u_k = d * e_k + e * e_k_1 + f * e_k_2 - b * u_k_1 - c * u_k_2;
    if (u_k < 0) u_k = 0;
    else if (u_k > 255) u_k = 255;
    //.................................................... Aplica variável de controlo
    analogWrite(CFW10, (uint8_t)u_k);
