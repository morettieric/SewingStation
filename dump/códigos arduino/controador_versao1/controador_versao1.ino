...
double a1 = 0.127419763779433;
double a2 = -0.249537770075301;
double a3 = 0.122267541459961;
double b1 = -2.738465357287645;
double b2 = 2.487912774401635;
double b3 = -0.749297881949897;
  //............................
...
void loop() {
  ...
  if(sample)
  {
    ...
    *************************************************************/  
    ...
    u_k = a1 * x1 + a2 * x2 + a3 * x3 - b1 * y1 + b2 * y2 + b3 * y3;
    if (u_k<0) u_k = 0;
